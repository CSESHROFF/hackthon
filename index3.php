...
body {
  ...
  background: url("https://cdn.glitch.com/6ae7a7fc-8884-4ea6-827b-8a1edaa47a61%2Fteahub.io-gradient-wallpaper-hd-2761495.png?v=1622863266753") no-repeat center center fixed; 
...
.Solid Waste .about-content,
.liquid Waste .serv-content,
.biodegrable .serv-content,
.non-biodegrable .skills-content,
...
section .title {
  ...
  background-image: linear-gradient(to bottom,rgb(153, 97, 182),rgba(203, 95, 162, 0.852));
}
...
.navbar.sticky {
  padding: 15px 0;
  background-image: linear-gradient(to bottom,rgb(153, 10, 225),rgba(243, 44, 167, 0.852));
}
.navbar .max-width {
  display: flex;
  align-items: center;
...
.home .home-content .text-3 span {
  color: rgb(222, 27, 240);
  text-shadow: 3px 2px 2px pink;
  font-weight: 500;
}
.home .home-content a {
  display: inline-block;
  background: rgb(220, 20, 210);
  color: #fff;
  font-size: 25px;
  padding: 12px 36px;
  margin-top: 20px;
  font-weight: 400;
  border-radius: 6px;
  border: 2px solid rgb(91, 160, 165);
  transition: all 0.3s ease;
}
.home .home-content a:hover {
  background-image: linear-gradient(to bottom,rgb(160, 225, 10),rgba(145, 194, 193, 0.852));
}
...
.experience .serv-contenr .card .text p{
  text-decoration-color: #f1f1f1;
}
...
.achievements .carousel .card img {
  height: 150px;
  width: 150px;
  object-fit: cover;
  border-radius: 50%;
...
.achievements .carousel .card:hover img {
  border-color: #fff;
}
...
header>a:hover{
    ...
    <script src="https://kit.fontawesome.com/a076d05399.js"></script><style media="all" id="fa-main">/*!
...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo">
                <a href="index3.php">Smart Waste Management</a>
            </div>
            <ul class="menu">
                <li><a href="display.php" class="menu-btn">Admin</a></li>
                <li><a href="index3.php" class="menu-btn">Home</a></li>
                <li><a href="login1php.php" class="menu-btn">login</a></li>
                <li><a href="register1.php" class="menu-btn">Register</a></li>
                <li><a href="#about" class="menu-btn">About</a></li>
                <li><a href="#contact" class="menu-btn">contact</a></li>
                <li><a href="register1.php" class="menu-btn">services</a></li>
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                <div class="text-1">
                    This is the waste management website.
                Users are hereby directed to follow the instructions for the the effective management of waste .</div>
                <div class="text-3">
                    whether it be <span class="typing">solid waste,liquid waste or other.</span><span class="typed-cursor typed-cursor--blink">|</span></div>
                <a href="#about">Know More About the scheme</a>
            </div>
        </div>
    </section>

    <div class="centre">
                    <img src="wow.jpg" width="100%" height="300px">
                </div>
        ...
        <div class="max-width">
            ...
            <div class="about-content">
                <div class="column left">
                    <img src="wt.jpg" width="200" height="500px">
                </div>
                <div class="column right">
                    <div class="text">
                        <span> This is a website for managing waste with the tech.</span></div>
                    <p>
                        The Government is bound to keep the city clean so we appeal to citizens to follow the instructions on the page and proceed accordingly. </p>
    ...
    <div class="column-left">
                 <img src="pic1.avif" width="70%" height="300px">
    ...
    <section class="contact" id="contact">
        <div class="max-width">
            <h2 class="title" style="color:pink">
                Contact Us</h2>
            <div class="row">
                <div class="various col-lg-3 col-md-4 col-sm-6">
                    <a href=" " target="_blank" style="color:white;"><i class="fab colo" aria-hidden="true"></i> Address:xyz<br>
                        Tel:1234567<br>
                        Mail us @ smartmanagementGOV@gmail.com</a>
                </div>
...
<hr>
    <footer>
        <p><strong>© Copyright 2023 Smart Waste Management System </strong></p>
    </footer>
